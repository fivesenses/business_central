...
class BusinessCentral::SalesOrderTest < Test::Unit::TestCase
  ...
  def test_get_collection
    stub_get("/salesOrders")
      ...
      .to_return(
        status: 200,
        body: fixture("get_salesOrders_200.json")
      )

    api_sales_order = BusinessCentral::SalesOrder.new(bc_client)
    sales_orders = api_sales_order.get
  ...
  def test_get_with_id
    stub_get("/salesOrders(1234)")
      ...
      .to_return(
        status: 200,
        body: fixture("get_salesOrder_200.json")
      )

    api_sales_order = BusinessCentral::SalesOrder.new(bc_client)
    sales_order = api_sales_order.get(1234)
