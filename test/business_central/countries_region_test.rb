...
class BusinessCentral::CountriesRegionTest < Test::Unit::TestCase
  ...
  def test_get_country_region
    stub_get("/countriesRegions(1234)")
      ...
      .to_return(
        status: 200,
        body: fixture("get_countriesRegion_200.json")
      )
  ...
  def test_get_countries_regions
    stub_get("/countriesRegions")
      ...
      .to_return(
        status: 200,
        body: fixture("get_countriesRegions_200.json")
      )
  ...
  def test_patch_countries_region
    ...
    stub_patch("/countriesRegions(1234)")
      .with(
        ...
        status: 200,
        body: fixture("patch_countriesRegion_200.json")
      )

    country = BusinessCentral::CountriesRegion
      .new(bc_client)
  ...
  def test_create_countries_region
    stub_post("/countriesRegions")
      .with(
        ...
        body: new_country_region
      ).to_return(
        status: 201,
        body: fixture("post_countriesRegion_200.json")
      )
