...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Interact with the Microsoft Dynamics365 Business Central API"
  spec.description = "Interact with the Microsoft Dynamics365 Business Central API"
